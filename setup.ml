...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5306cd7508d219f0778de0c6babf37f4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          version = "0.0.1";
          license =
            OASISLicense.OtherLicense "http://www.boost.org/LICENSE_1_0.txt";
          ...
          maintainers = [];
          authors = ["yutopp"];
          homepage = Some "https://github.com/yutopp/rill_ir";
          bugreports = None;
          synopsis = "A IR library for the Rill programming language";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\179\178\200=9D\024]oD\024\190Q\157\157\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
